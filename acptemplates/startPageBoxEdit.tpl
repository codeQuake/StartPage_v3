...
<div class="mainHeadline">
    <img src="{@RELATIVE_WBB_DIR}/icon/boxEditL.png" alt="" />
    <div class="headlineContainer">
        <h2>{lang}wbb.acp.startpage.box.edit{/lang}</h2>
    </div>
</div>
...
{if $success|isset}
    <p class="success">{lang}wbb.acp.startpage.box.edit.success{/lang}</p>
{/if}
...
<form method="post" action="index.php?form=StartPageBoxEdit&amp;boxID={$boxID}">
        ...
        <div class="container-1">
            <fieldset>
                ...
                <div class="formElement {if $errorField == 'boxname'} formError{/if}">
                    ...
                    <div class="formField">
                        <input type="text" class="inputText" name="boxname" id="boxname" value="{$boxname}" readonly/>
